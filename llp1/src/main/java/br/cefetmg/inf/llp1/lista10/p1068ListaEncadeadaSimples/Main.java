package br.cefetmg.inf.llp1.lista10.p1068ListaEncadeadaSimples;
...
class Lista {
    ...
    public Character removerInicio() { 
        ...
        Character valorRemovido = obterInicio();
    ...
    public Character removerFim() {
        ...
        Character valorRemovido = obterFim();
        fim = fim.anterior;
        quantos--;
        if(vazia())
            inicio = null;
    ...
    public Character remover(int posicao) { 
        ...
        Character valorRemovido = obter(p);
